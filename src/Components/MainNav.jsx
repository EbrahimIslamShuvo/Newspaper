                        ...
                        <div className="flex items-center justify-between  py-3.5">
                            <div className="grid gap-3">
                                <div className="flex items-center gap-3">
                                    <div onClick={() => activeSideBar("block")} className="p-1 border-1 rounded-full border-gray-200 hover:bg-gray-200">
                            ...
                            <div className="">
                                <NavLink to={"/"}>
                                    <img className='md:w-70 w-45' src="https://cdn.ittefaqbd.com/contents/themes/public/style/images/logo.svg" alt="logo" />
                                </NavLink>
                            </div>
